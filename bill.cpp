...
int main ()
{
    Show_bill a ;
        ...
        cout<<"\n\t\t\t ** Menu ** \n";
        cout<<" \n  [1] puri bhaji                      : RS. 660 /- "; 
        cout<<" \n  [2] Aloo paranth                    : RS. 660  /- "; 
        cout<<" \n  [3] sada dosa                       : RS. 600  /- "; 
        cout<<" \n  [4] masala dosa                     : RS. 660  /- ";
        cout<<" \n  [5] uttappam                        : RS. 600  /- \n";
